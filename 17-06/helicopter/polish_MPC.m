...
Q_kalman = [1,  0, 0; 0, 1, 0; 0, 0, 100];
R_kalman = [1 0; 0 1];

Q_MPC = [2000, 0, 0; 0, 20, 0; 0, 0, 1000];
R_MPC = [5];
...
% Constraints
x_min = [-pi/4; -100; -335] * 2;
x_max = [ pi/4;  100; 337] * 2;
u_lb = [-1];
u_ub = [1];
...
% 
% N = 25;
discrete_sys = c2d(ss(A_lin,B_lin,C,0), 0.02);
discrete_A = discrete_sys.A;
