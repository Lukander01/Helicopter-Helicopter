...
Q_MPC = [200000, 0, 0; 0, 40000, 0; 0, 0, 1000];
R_MPC = [18];




discrete_sys = c2d(ss(A_lin,B_lin,C,0), t_mpc);
discrete_A = discrete_sys.A;  %% by hand instead of c2d
discrete_B = discrete_sys.B;
%%
[P_inf, ~, K_inf] = dare(discrete_A, discrete_B, Q_MPC, R_MPC);
P = P_inf;
